    ...
    return <div className="container-fluid d-flex align-items-center p-5" style={background}>
        <div data-aos="fade-up" data-aos-duration="1000" className="container ">
            <div className="row">
                ...
                <div className=" col-6" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="500">
                    <img src="assets/images/stay_safe.svg" width="100%" />
                </div>
                <div data-aos="fade-up" data-aos-duration="1000" className="col-6 d-flex flex-column justify-content-around">
